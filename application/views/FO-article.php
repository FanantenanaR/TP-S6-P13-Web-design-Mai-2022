<header class="masthead h-100" style="background-image:url('<?php echo uploadedfile_url("environnement.png"); ?> ');">
        ...
        <div class="row">
            <div class="col-md-10 col-lg-8 mx-auto position-relative">
                <div class="post-heading">
                    ...
                    <h2 class="subheading"><?php echo $article['description']; ?></h2><span class="meta">Posté le <?php echo $article['datepubli'];?></span>
                </div>
            </div>
        </div>
    </div>
